	  ...
	  _createClass(SingleDatePicker, [{
	    ...
	    value: function () {
	      function getDayPickerContainerClasses() {
	        ...
	        var directionAnchor = _props3.directionAnchor;
	        ...
	        var dayPickerClassName = (0, _classnames2['default'])('SingleDatePicker__picker', {
	          ...
	          'SingleDatePicker__picker--direction-left': directionAnchor === _constants.DIRECTION_ANCHOR_LEFT,
	          'SingleDatePicker__picker--direction-right': directionAnchor === _constants.DIRECTION_ANCHOR_RIGHT,
