...
/***/ function(module, exports, __webpack_require__) {
	...
	var defaultProps = {
	  ...
	  directionAnchor: _constants.DIRECTION_ANCHOR_LEFT,
	  withPortal: false,
	  ...
	  _createClass(DateRangePicker, [{
	    ...
	    value: function () {
	      function getDayPickerContainerClasses() {
	        ...
	        var directionAnchor = _props6.directionAnchor;
	        ...
	        var dayPickerClassName = (0, _classnames2['default'])('DateRangePicker__picker', {
	          'DateRangePicker__picker--direction-left': directionAnchor === _constants.DIRECTION_ANCHOR_LEFT,
	          'DateRangePicker__picker--direction-right': directionAnchor === _constants.DIRECTION_ANCHOR_RIGHT,
	    ...
	    value: function () {
	      function renderDayPicker() {
	        ...
	        var initialVisibleMonth = _props13.initialVisibleMonth;
