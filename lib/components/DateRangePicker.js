...
/***/ function(module, exports, __webpack_require__) {
	...
	var _toMomentObject = __webpack_require__(16);

	var _toMomentObject2 = _interopRequireDefault(_toMomentObject);

	var _toLocalizedDateString = __webpack_require__(17);
	...
	var _isNextDay = __webpack_require__(20);
	...
	var _OutsideClickHandler = __webpack_require__(22);

	var _OutsideClickHandler2 = _interopRequireDefault(_OutsideClickHandler);

	var _DateRangePickerInput = __webpack_require__(23);
	  ...
	  _createClass(DateRangePicker, [{
	    ...
	    value: function () {
	      function onEndDateChange(endDateString) {
	        ...
	        var allowPastDates = _props2.allowPastDates;
	        var startDate = _props2.startDate;
	        var onDatesChange = _props2.onDatesChange;
	        var onFocusChange = _props2.onFocusChange;

	        var isEndDateValid = endDate && (!this.isPastDate(endDate) || allowPastDates) && !(0, _isInclusivelyBeforeDay2['default'])(endDate, startDate);
	        if (isEndDateValid) {
	    ...
	    value: function () {
	      function onStartDateChange(startDateString) {
	        ...
	        var isStartDateValid = startDate && !this.isPastDate(startDate);
	        if (isStartDateValid) {
	    ...
	    value: function () {
	      function doesNotMeetMinimumNights(day) {
	        ...
	        var dayDiff = startDate ? day.diff(startDate, 'days') : day.diff(today, 'days');

	        return focusedInput === _constants.END_DATE && dayDiff < minimumNights && dayDiff >= 0;
	      }
	    ...
	    value: function () {
	      function isPastDate(day) {
	        ...
	        return !(0, _isInclusivelyBeforeDay2['default'])((0, _moment2['default'])(), day);
	      }
	    ...
	    value: function () {
	      function isBlocked(day) {
	        return this.props.isDayBlocked(day) || this.isPastDate(day) || this.doesNotMeetMinimumNights(day);
	      }
	    ...
	    value: function () {
	      function renderDayPicker() {
	        ...
	        var numberOfMonths = _props12.numberOfMonths;
	        var orientation = _props12.orientation;
	        var monthFormat = _props12.monthFormat;
	        var onPrevMonthClick = _props12.onPrevMonthClick;
	        var onNextMonthClick = _props12.onNextMonthClick;
	        var withPortal = _props12.withPortal;
	        var withFullScreenPortal = _props12.withFullScreenPortal;
	        var enableOutsideDays = _props12.enableOutsideDays;
	        var initialVisibleMonth = _props12.initialVisibleMonth;
	        ...
	        var modifiers = {
	          ...
	          'blocked-past-date': function () {
	            function blockedPastDate(day) {
	              return _this2.isPastDate(day);
	            }

	            return blockedPastDate;
	          }(),
	    ...
	    value: function () {
	      function render() {
	        ...
	        var showClearDates = _props13.showClearDates;
	        var disabled = _props13.disabled;
	        var startDateId = _props13.startDateId;
	        var endDateId = _props13.endDateId;
	        var phrases = _props13.phrases;
