...
/***/ function(module, exports, __webpack_require__) {
	...
	var DayPicker = function (_React$Component) {
	  ...
	  function DayPicker(props) {
	    ...
	    _this.hasSetInitialVisibleMonth = !!props.focused;
	    _this.state = {
	      currentMonth: props.focused ? props.initialVisibleMonth() : (0, _moment2['default'])(),
	  ...
	  _createClass(DayPicker, [{
	    ...
	    value: function () {
	      function componentWillReceiveProps(nextProps) {
	        if (!this.hasSetInitialVisibleMonth && nextProps.focused) {
	    ...
	    value: function () {
	      function getMonthHeightByIndex(i) {
	        var $transitionContainer = (0, _jquery2['default'])(_reactDom2['default'].findDOMNode(this.refs.transitionContainer));
	    ...
	    value: function () {
	      function getMonthHeight($el) {
	        ...
	        return $el.find('.js-CalendarMonth__caption').outerHeight(true) + $el.find('.js-CalendarMonth__grid').height() + 1; // for border
	      }
	    ...
	    value: function () {
	      function initializeDayPickerWidth() {
	        var $calendarMonthGrid = (0, _jquery2['default'])(_reactDom2['default'].findDOMNode(this.refs.calendarMonthGrid));
	    ...
	    value: function () {
	      function updateStateAfterMonthTransition() {
	        ...
	        $calendarMonthGrid.find('.CalendarMonth').css(Object.assign((0, _getTransformStyles2['default'])('none'), {
	          opacity: ''
	        }));
	    ...
	    value: function () {
	      function adjustDayPickerHeight() {
	        ...
	        var $transitionContainer = (0, _jquery2['default'])(_reactDom2['default'].findDOMNode(this.refs.transitionContainer));
	        var heights = $transitionContainer.find('.CalendarMonth[data-visible="true"]').get().map(function (month) {
	          return _this2.getMonthHeight((0, _jquery2['default'])(month));
	        });

	        var newMonthHeight = Math.max.apply(Math, _toConsumableArray(heights)) + MONTH_PADDING;
	    ...
	    value: function () {
	      function translateFirstDayPickerForAnimation(translationValue) {
	        ...
	        var $transitionContainer = (0, _jquery2['default'])(_reactDom2['default'].findDOMNode(this.refs.transitionContainer));
	        $transitionContainer.find('.CalendarMonth').first().css(Object.assign((0, _getTransformStyles2['default'])(transformValue), {
	          opacity: 1
	        }));
	      }
